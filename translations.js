...
const translations = {
  ...
  faq: {
    ...
    p2_a: { en: "Simply browse our verified teachers, select one that matches your needs, and click Book Lesson.", zhTW: "只需瀏覽我們的已驗證導師，選擇符合您需求的導師，然後點擊「預訂課堂」。", zhCN: "只需浏览我们的已验证导师，选择符合您需求的导师，然后点击「预订课堂」。" },
  ...
  schedule: {
    ...
    book_lesson: { en: "Book a Lesson", zhTW: "預訂課堂", zhCN: "预约课堂" },
