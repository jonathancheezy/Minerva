...
(function(){
  const T = {
    ...
    btn_register_teacher:{en:"Register as Teacher →",zhTW:"申請成為導師 →",zhCN:"立即注册导师 →"},
    btn_register_parent:{en:"Register as Parent/Student →",zhTW:"立即報名 →",zhCN:"立即注册家长/学生 →"},
    ...
    admin:{
      ...
      email_placeholder:{en:"Enter your email",zhTW:"輸入電郵",zhCN:"输入电邮"},
      ...
      redirect_msg:{en:"Redirecting to admin dashboard...",zhTW:"正在跳轉至管理員頁面...",zhCN:"正在跳转至管理后台..."},
    ...
    login:{
      ...
      login_subtitle_teacher:{en:"Login to access your teacher dashboard",zhTW:"登入查看導師專區",zhCN:"登录查看导师主页"},
      login_subtitle_parent:{en:"Login to access your parent dashboard",zhTW:"登入查看家長專區",zhCN:"登录查看家长主页"},
      success_title:{en:"✅ Login successful!",zhTW:"✅ 登入成功！",zhCN:"✅ 登录成功！"},
      "Email Address":{en:"Email Address",zhTW:"電郵地址",zhCN:"电邮地址"},
      "Login":{en:"Login",zhTW:"登入",zhCN:"登录"},
      "Password":{en:"Password",zhTW:"密碼",zhCN:"密码"}
    },
      hero_welcome_teacher:{en:"Welcome back, teacher!",zhTW:"歡迎回來，導師！",zhCN:"欢迎回来，导师！"},
      hero_subtitle_teacher:{en:"Login to manage your students and schedule.",zhTW:"登入以管理學生和時間表。",zhCN:"登录以管理学生和时间表。"},
      hero_welcome_parent:{en:"Welcome back!",zhTW:"歡迎回來！",zhCN:"欢迎回来！"},
      hero_subtitle_parent:{en:"Login to manage your lessons and track progress.",zhTW:"登入以管理課堂和追蹤進度。",zhCN:"登录以管理课堂和追踪进度。"},
      ...
      dont_have_account:{en:"Don't have an account?",zhTW:"還沒有帳戶？",zhCN:"还没有帐户？"},
    ...
    register:{
      ...
      btn_register:{en:"Register",zhTW:"提交報名",zhCN:"立即登记"},
      register_btn:{en:"Register",zhTW:"提交報名",zhCN:"立即登记"},
      teacher_register:{en:"Teacher Registration",zhTW:"導師申請",zhCN:"立即注册导师"},
      parent_register:{en:"Parent Registration",zhTW:"家長/學生報名",zhCN:"立即注册家长/学生"},
    ...
    schedule:{
      ...
      booking_summary:{en:"Booking Summary",zhTW:"預訂詳情",zhCN:"订单确认"},
      confirm_booking:{en:"Confirm Booking",zhTW:"確認預訂",zhCN:"确认订单"},
      ...
      upcoming_lessons_title:{en:"Upcoming Lessons",zhTW:"即將開始的課堂",zhCN:"即将上课"},
      past_lessons_title:{en:"Past Lessons",zhTW:"過去的課堂",zhCN:"历史课程"},
      add_availability:{en:"Add Availability",zhTW:"新增可預約時段",zhCN:"添加可预约时间"},
    ...
    teacher_dash:{
      ...
      upcoming_lessons:{en:"Upcoming Lessons",zhTW:"即將開始的課堂",zhCN:"即将上课"},
      upcoming_lessons_title:{en:"Upcoming Lessons",zhTW:"即將開始的課堂",zhCN:"即将上课"},
