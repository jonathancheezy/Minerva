...
(function(){
  const T = {
    ...
    waitlist_teachers:{en:"Register as Teacher",zhTW:"註冊成為導師",
      error_load:{en:"Failed to load teachers. Please try again.",zhTW:"無法載入導師，請重試。",zhCN:"无法载入导师，请重试。"},
      heading_title:{en:"Find Your Perfect Teacher",zhTW:"尋找您的理想導師",zhCN:"寻找您的理想导师"},zhCN:"注册成为导师"},
    ...
    footer_terms:{en:"Terms & Conditions",zhTW:"條款及細則",
      collect_for:{en:"Collects information for",zhTW:"收集信息用于",zhCN:"收集信息用于"},
      data_used_for:{en:"Data used for",zhTW:"資料用於",zhCN:"资料用于"},
      last_updated:{en:"Last Updated",zhTW:"最後更新",zhCN:"最后更新"},
      lessons_conducted:{en:"Lessons conducted",zhTW:"進行的課堂",zhCN:"进行的课堂"},
      pdpo_rights:{en:"Your PDPO Rights",zhTW:"您的《個人資料（私隱）條例》權利",zhCN:"您的《个人资料（私隐）条例》权利"},
      questions:{en:"Questions?",zhTW:"有問題？",zhCN:"有问题？"},
      sec1:{en:"Introduction",zhTW:"簡介",zhCN:"简介"},
      sec10_heading:{en:"Minerva Platform",zhTW:"Minerva 平台",zhCN:"Minerva 平台"},
      sec11:{en:"Teacher Responsibilities",zhTW:"導師責任",zhCN:"导师责任"},
      sec12:{en:"Platform Fees & Commission",zhTW:"平台費用與佣金",zhCN:"平台费用与佣金"},
      sec13:{en:"Payment Terms",zhTW:"付款條款",zhCN:"付款条款"},
      sec14:{en:"Dispute Resolution",zhTW:"爭議解決",zhCN:"争议解决"},
      sec14_1:{en:"For Parents",zhTW:"給家長",zhCN:"给家长"},
      sec14_2:{en:"For Teachers",zhTW:"給導師",zhCN:"给导师"},
      sec14_3:{en:"Evidence",zhTW:"證據",zhCN:"证据"},
      sec14_4:{en:"Decision",zhTW:"決定",zhCN:"决定"},
      sec14_5:{en:"Appeal",zhTW:"上訴",zhCN:"上诉"},
      sec14_6:{en:"Escalation",zhTW:"升級",zhCN:"升级"},
      sec14_7:{en:"Excluded Disputes",zhTW:"不包括的爭議",zhCN:"不包括的争议"},
      sec15:{en:"Indemnification",zhTW:"賠償",zhCN:"赔偿"},
      sec16:{en:"Limitation of Liability",zhTW:"責任限制",zhCN:"责任限制"},
      sec17:{en:"Termination",zhTW:"終止",zhCN:"终止"},
      sec18:{en:"Governing Law",zhTW:"適用法律",zhCN:"适用法律"},
      sec19:{en:"Entire Agreement",zhTW:"完整協議",zhCN:"完整协议"},
      sec2:{en:"Eligibility",zhTW:"資格",zhCN:"资格"},
      sec20:{en:"Amendments",zhTW:"修訂",zhCN:"修订"},
      sec21:{en:"Contact",zhTW:"聯繫",zhCN:"联系"},
      sec3:{en:"Services",zhTW:"服務",zhCN:"服务"},
      sec4:{en:"User Accounts",zhTW:"用戶帳戶",zhCN:"用户帐户"},
      sec4_1:{en:"Parents & Students",zhTW:"家長與學生",zhCN:"家长与学生"},
      sec4_2:{en:"Teachers",zhTW:"導師",zhCN:"导师"},
      sec5:{en:"Booking & Lessons",zhTW:"預訂與課堂",zhCN:"预订与课堂"},
      sec5_1:{en:"Scheduling",zhTW:"預約",zhCN:"预约"},
      sec5_2:{en:"Lesson Format",zhTW:"課堂形式",zhCN:"课堂形式"},
      sec5_3:{en:"Cancellations",zhTW:"取消",zhCN:"取消"},
      sec5_4:{en:"Refunds",zhTW:"退款",zhCN:"退款"},
      sec6:{en:"Payments & Pricing",zhTW:"付款與定價",zhCN:"付款与定价"},
      sec7:{en:"Minerva Verification",zhTW:"Minerva 驗證",zhCN:"Minerva 验证"},
      sec7_1:{en:"For Teachers",zhTW:"給導師",zhCN:"给导师"},
      sec7_2:{en:"For Parents",zhTW:"給家長",zhCN:"给家长"},
      sec8:{en:"Data & Privacy",zhTW:"資料與私隱",zhCN:"资料与隐私"},
      sec9:{en:"Minerva Guarantee",zhTW:"Minerva 保證",zhCN:"Minerva 保证"},
      users_must_not:{en:"Users must not",zhTW:"用戶不得",zhCN:"用户不得"},zhCN:"条款及细则"},
    // ── Admin ──
    admin:{
    ...
    admin_dash:{
      ...
      nav_students:{en:"Students",zhTW:"學生",
      ...
      status_scheduled:{en:"Scheduled",zhTW:"已預訂",zhCN:"已预订"},zhCN:"学生"}
    },
    ...
    login:{
      ...
      "Password":{en:"Password",zhTW:"密碼",
      no_account:{en:"Don't have an account?",zhTW:"還沒有帳戶？",zhCN:"还没有帐户？"},zhCN:"密码"}
    },
    ...
    register:{
      ...
      section_profile:{en:"Teaching Profile",zhTW:"教學資料",
      btn_change_photo:{en:"Change Photo",zhTW:"更換照片",zhCN:"更换照片"},
      btn_delete_forever:{en:"Delete Forever",zhTW:"永久刪除",zhCN:"永久删除"},
      btn_discard_leave:{en:"Discard & Leave",zhTW:"放棄並離開",zhCN:"放弃并离开"},
      btn_keep_account:{en:"Keep Account",zhTW:"保留帳戶",zhCN:"保留帐户"},
      btn_keep_editing:{en:"Keep Editing",zhTW:"繼續編輯",zhCN:"继续编辑"},
      btn_save_changes:{en:"Save Changes",zhTW:"儲存更改",zhCN:"储存更改"},
      heading_delete_account:{en:"Delete Account",zhTW:"刪除帳戶",zhCN:"删除帐户"},
      heading_discard_changes:{en:"Discard Changes?",zhTW:"放棄更改？",zhCN:"放弃更改？"},zhCN:"教学资料"},
    ...
    parent_dash:{
      ...
      schedule:{en:"Schedule",zhTW:"時間表",
      btn_book_new:{en:"Book New Lesson",zhTW:"預訂新課堂",zhCN:"预订新课堂"},
      btn_cancel:{en:"Cancel",zhTW:"取消",zhCN:"取消"},
      btn_confirm_booking:{en:"Confirm Booking",zhTW:"確認預訂",zhCN:"确认预订"},
      nav_next:{en:"Next",zhTW:"下一個",zhCN:"下一个"},
      nav_prev:{en:"Previous",zhTW:"上一個",zhCN:"上一个"},
      step1_select_teacher:{en:"Step 1: Select Teacher",zhTW:"第一步：選擇導師",zhCN:"第一步：选择导师"},
      step2_select_date:{en:"Step 2: Select Date",zhTW:"第二步：選擇日期",zhCN:"第二步：选择日期"},
      step3_select_time:{en:"Step 3: Select Time",zhTW:"第三步：選擇時間",zhCN:"第三步：选择时间"},
      tab_history:{en:"History",zhTW:"歷史",zhCN:"历史"},
      tab_upcoming:{en:"Upcoming",zhTW:"即將到來",zhCN:"即将到来"},
      btn_add_slot:{en:"Add Time Slot",zhTW:"添加時段",zhCN:"添加时段"},
      heading_add_availability:{en:"Add Availability",zhTW:"添加可用時間",zhCN:"添加可用时间"},
      heading_monthly_calendar:{en:"Monthly Calendar",zhTW:"月度日曆",zhCN:"月度日历"},
      heading_my_schedule:{en:"My Schedule",zhTW:"我的時間表",zhCN:"我的时间表"},
      heading_upcoming_bookings:{en:"Upcoming Bookings",zhTW:"即將到來的預訂",zhCN:"即将到来的预订"},
      label_date:{en:"Date",zhTW:"日期",zhCN:"日期"},
      label_end_time:{en:"End Time",zhTW:"結束時間",zhCN:"结束时间"},
      label_repeat:{en:"Repeat",zhTW:"重複",zhCN:"重复"},
      label_start_time:{en:"Start Time",zhTW:"開始時間",zhCN:"开始时间"},zhCN:"时间表"},
      teachers:{en:"Teachers",zhTW:"導師",zhCN:"导师"},
      messages:{en:"Messages",zhTW:"訊息",zhCN:"讯息"},
      learning_progress:{en:"Learning Progress",zhTW:"學習進度",zhCN:"学习进度"},
      view_all:{en:"View All",zhTW:"查看全部",
      footer_text:{en:"© 2026 Minerva Learning Ltd. Hong Kong. All rights reserved.",zhTW:"© 2026 Minerva Learning Ltd. 香港。保留所有權利。",zhCN:"© 2026 Minerva Learning Ltd. 香港。保留所有权利。"},
      ...
      heading_your_teachers:{en:"Your Teachers",zhTW:"您的導師",zhCN:"您的导师"},zhCN:"查看全部"}
    },
