...
(function(){
  const T = {
    ...
    register:{
      ...
      opt_cantonese:{en:"Cantonese",zhTW:"粵語",zhCN:"粵語"},
      opt_lang_english:{en:"English",zhTW:"英語",zhCN:"英語"},
      opt_mandarin:{en:"Mandarin",zhTW:"普通話",zhCN:"普通話"},
      ...
      opt_google:{en:"Google Search",zhTW:"Google 搜尋",zhCN:"Google 搜尋"},
    ...
    terms:{
      ...
      p9:{en:"Teachers agree to pay Minerva a commission on all completed lessons. Commission rates are clearly displayed and agreed upon at registration. First 100 registered teachers receive zero commission for their first four classes.",zhTW:"Minerva為未按約定交付的課堂提供爭議解決程序。在調查後，Minerva可酌情從託管系統發出退款。",zhCN:"Minerva为未按约定交付的课堂提供争议解决程序。在调查后，Minerva可酌情从托管系统发出退款。"},
      ...
      sec10:{en:"7.3 Cancellations",zhTW:"10. 修訂",zhCN:"10. 修订"},
      ...
      p12:{en:"Lessons must be booked through the Minerva platform. Off-platform arrangements void our protection policies.",zhTW:"使用Minerva，即表示您同意根據我們的隱私政策收集和使用您的個人資料。",zhCN:"使用Minerva，即表示您同意根据我们的隐私政策收集和使用您的个人资料。"},
      p13:{en:"Cancellation policies apply as stated in Section 5.2. Repeated no-shows may result in account suspension.",zhTW:"Minerva保留暫停或終止違反這些條款或從事欺詐活動的帳戶的權利。",zhCN:"Minerva保留暂停或终止违反这些条款或从事欺诈活动的帐户的权利。"},
      p14:{en:"Users must not exchange contact information (phone numbers, email addresses, social media handles) or arrange lessons outside the Minerva platform. Violation of this policy may result in:",zhTW:"導師必須完成我們的驗證流程，包括身份驗證、資歷核實和推薦人核實，然後才能在平台上提供課堂。",zhCN:"导师必须完成我们的验证流程，包括身份验证、资历核实和推荐人核实，然后才能在平台上提供课堂。"},
      ...
      p27:{en:"In case of disputes, users should follow these steps:",zhTW:"Minerva保留以30天通知更改佣金率的權利。",zhCN:"Minerva保留以30天通知更改佣金率的权利。"},
      p28:{en:"Minerva reserves the right to terminate or suspend accounts that:",zhTW:"導師不得在平台上分享個人聯繫資訊。",zhCN:"导师不得在平台上分享个人联系信息。"},
      p29:{en:"Minerva may modify these terms at any time with 30 days notice. Users will be notified via email or platform notice. Continued use after changes constitutes acceptance of new terms.",zhTW:"完成註冊即表示您確認您已年滿18歲。",zhCN:"完成注册即表示您确认您已年满18岁。"},
      p30:{en:"These Terms & Conditions are governed by the laws of the Hong Kong Special Administrative Region. Any disputes shall be subject to the exclusive jurisdiction of Hong Kong courts.",zhTW:"這些條款構成您與Minerva之間關於您使用平台的完整協議。",zhCN:"这些条款构成您与Minerva之间关于您使用平台的完整协议。"},
      ...
      sec14_4:{en:"14.4 Data Retention",zhTW:"14.4 解決時間表",zhCN:"14.4 解决时间表"},
      sec14_5:{en:"14.5 Your Rights",zhTW:"14.5 退款流程",zhCN:"14.5 退款流程"},
      sec14_6:{en:"14.6 Data Security",zhTW:"14.6 香港小額錢債審裁處",zhCN:"14.6 香港小额钱债审裁处"},
      sec14_7:{en:"14.7 Data Transfers",zhTW:"14.7 資料轉讓",zhCN:"14.7 资料转让"},
      sec15:{en:"15. Intellectual Property",zhTW:"15. 知識產權",zhCN:"15. 知识产权"},
      sec16:{en:"16. Prohibited Activities",zhTW:"16. 私隱政策",zhCN:"16. 隐私政策"},
      sec17:{en:"17. Dispute Resolution",zhTW:"17. 適用法律",zhCN:"17. 适用法律"},
      sec18:{en:"18. Termination",zhTW:"18. 終止",zhCN:"18. 终止"},
      sec19:{en:"19. Amendments",zhTW:"19. 聯繫我們",zhCN:"19. 联系我们"},
      sec2:{en:"2. Teacher Independence",zhTW:"資格",zhCN:"資格"},
      sec20:{en:"20. Governing Law",zhTW:"20. 修訂",zhCN:"20. 修订"},
      sec21:{en:"21. Contact Information",zhTW:"聯繫",zhCN:"聯繫"},
      sec3:{en:"3. Services Description",zhTW:"服務",zhCN:"服務"},
      sec4:{en:"4. User Accounts",zhTW:"用戶帳戶",zhCN:"用戶帳戶"},
      sec4_1:{en:"4.1 For Teachers",zhTW:"家長與學生",zhCN:"家長與學生"},
      sec4_2:{en:"4.2 For Students/Parents",zhTW:"導師",zhCN:"導師"},
      sec5:{en:"5. Payment Terms",zhTW:"預訂與課堂",zhCN:"預訂與課堂"},
      sec5_1:{en:"5.1 Platform Fees",zhTW:"5.1 平台費用",zhCN:"5.1 平台费用"},
      sec5_2:{en:"5.2 Escrow System",zhTW:"5.2 付款保護",zhCN:"5.2 付款保障"},
      sec5_3:{en:"5.3 Commission",zhTW:"5.3 退款",zhCN:"5.3 退款"},
      sec5_4:{en:"5.4 Payment Release",zhTW:"5.4 付款釋出",zhCN:"5.4 付款释放"},
      ...
      sec8:{en:"8. Off-Platform Communication Prohibited",zhTW:"8. 資料及私隱",zhCN:"8. 资料及私隐"},
      sec9:{en:"9. Content and Reviews",zhTW:"9. Minerva保證",zhCN:"9. Minerva保证"},
      ...
      li_16:{en:"Identity verification (HKID/Passport)",zhTW:"學生無故缺席：恕不退還，款項支付予導師",zhCN:"学生无故缺席：恕不退还，款项支付予导师"},
      li_17:{en:"Qualification checks",zhTW:"付款於課堂完成確認後3個工作日內釋出",zhCN:"付款于课堂完成确认后3个工作日内放出"},
      li_18:{en:"Reference verification",zhTW:"高峰期最多5個工作日",zhCN:"高峰期最多5个工作日"},
      li_19:{en:"Interview assessment",zhTW:"身份驗證（香港身份證/護照）",zhCN:"身份验证（香港身份证/护照）"},
      li_20:{en:"In-person at agreed locations",zhTW:"資歷核查",zhCN:"资历核查"},
      li_21:{en:"Online via video conferencing",zhTW:"推薦人核查",zhCN:"推荐人核查"},
      li_22:{en:"Hybrid arrangements as agreed between parties",zhTW:"面試評估",zhCN:"面试评估"},
      li_23:{en:"Immediate account suspension",zhTW:"按約定地點面授",zhCN:"按约定地点面授"},
      li_24:{en:"Forfeit of escrow payment protection",zhTW:"透過視像會議網上授課",zhCN:"透过视像会议网上授课"},
      li_25:{en:"Legal action for breach of contract",zhTW:"由雙方協定的混合安排",zhCN:"由双方协定的混合安排"},
      li_26:{en:"Contains personal information (phone numbers, addresses)",zhTW:"即時帳戶暫停",zhCN:"即时帐户暂停"},
      li_27:{en:"Is defamatory, abusive, or discriminatory",zhTW:"喪失託管付款保障",zhCN:"丧失托管付款保障"},
      ...
      li_34:{en:"Minerva shall not be liable for any loss of income, reputation, or business opportunities arising from platform use.",zhTW:"Minerva不對任何間接、偶然、特殊、後果性或懲罰性損害賠償負責",zhCN:"Minerva不对任何间接、偶然、特殊、后果性或惩罚性损害赔偿负责"},
      li_35:{en:"Account registration and verification",zhTW:"我們對任何索償的總責任不超過索償人所提出的索償金額",zhCN:"我们对任何索偿的总责任不超过索偿人提出的索偿金额"},
      li_36:{en:"Matching teachers with students",zhTW:"Minerva不保證導師資歷的準確性",zhCN:"Minerva不保证导师资历的准确性"},
      li_37:{en:"Payment processing",zhTW:"用戶承擔驗證導師資歷的全部責任",zhCN:"用户承担验证导师资历的全部责任"},
      li_38:{en:"Platform improvement and analytics",zhTW:"Minerva不對任何收入損失、名譽損失或業務損失負責",zhCN:"Minerva不对任何收入损失、名誉损失或业务损失负责"},
      li_39:{en:"Communication about services",zhTW:"帳戶註冊及驗證",zhCN:"帐户注册及验证"},
      li_40:{en:"Name and contact information",zhTW:"為導師及學生配對",zhCN:"为导师及学生配对"},
      li_41:{en:"HKID/Passport for verification",zhTW:"付款處理",zhCN:"付款处理"},
      li_42:{en:"Qualification documents",zhTW:"平台改進及分析",zhCN:"平台改进及分析"},
      li_43:{en:"Payment information",zhTW:"關於服務的通訊",zhCN:"关于服务的通讯"},
      li_44:{en:"Lesson history and progress data",zhTW:"姓名及聯繫方式",zhCN:"姓名及联系方式"},
      li_45:{en:"Communication records",zhTW:"香港身份證/護照以作驗證",zhCN:"香港身份证/护照以作验证"},
      li_46:{en:"Providing and maintaining our services",zhTW:"資格文件",zhCN:"资格文件"},
      li_47:{en:"Processing payments via Stripe, Alipay, WeChat Pay",zhTW:"付款資訊",zhCN:"付款信息"},
      li_48:{en:"Teacher verification through third-party services",zhTW:"課堂歷史及進度數據",zhCN:"课堂历史及进度数据"},
      li_49:{en:"Analytics to improve our platform",zhTW:"通訊記錄",zhCN:"通讯记录"},
      li_50:{en:"Legal compliance",zhTW:"提供及維護我們的服務",zhCN:"提供及维护我们的服务"},
      li_51:{en:"Request access to your personal data",zhTW:"通過Stripe、Alipay、WeChat Pay處理付款",zhCN:"通过Stripe、Alipay、WeChat Pay处理付款"},
      li_52:{en:"Request correction of inaccurate data",zhTW:"通過第三方服務進行導師驗證",zhCN:"通过第三方服务进行导师验证"},
      li_53:{en:"Request deletion of your data (subject to legal retention requirements)",zhTW:"分析以改進我們的平台",zhCN:"分析以改进我们的平台"},
      li_54:{en:"Withdraw consent for marketing communications",zhTW:"法律合規",zhCN:"法律合规"},
      li_55:{en:"Use the platform for illegal purposes",zhTW:"要求查閱您的個人資料",zhCN:"要求查阅您的个人资料"},
      li_56:{en:"Harass, abuse, or harm other users",zhTW:"要求更正不正確的資料",zhCN:"要求更正不正确的资料"},
      li_57:{en:"Attempt to circumvent our verification process",zhTW:"要求刪除您的資料（須受法律保留要求約束）",zhCN:"要求删除您的资料（须受法律保留要求约束）"},
      li_58:{en:"Make off-platform payments to avoid commissions",zhTW:"撤回對營銷通訊的同意",zhCN:"撤回对营销通讯的同意"},
      li_59:{en:"Provide false information during registration",zhTW:"將平台用於非法目的",zhCN:"将平台用于非法目的"},
      li_60:{en:"Use the platform to solicit other users for external services",zhTW:"騷擾、虐待或傷害其他用戶",zhCN:"骚扰、虐待或伤害其他用户"},
      li_61:{en:"Violate these Terms & Conditions",zhTW:"嘗試規避我們的驗證流程",zhCN:"尝试规避我们的验证流程"},
      li_62:{en:"Engage in fraudulent activity",zhTW:"進行平台外付款以規避佣金",zhCN:"进行平台外付款以规避佣金"},
      li_63:{en:"Repeatedly breach payment obligations",zhTW:"在註冊時提供虛假資訊",zhCN:"在注册时提供虚假信息"},
      li_64:{en:"Generate multiple justified complaints",zhTW:"使用平台招攬其他用戶使用外部服務",zhCN:"使用平台招揽其他用户使用外部服务"},
      li_65:{en:"Email: legal@minerva.hk",zhTW:"違反這些條款及細則",zhCN:"违反这些条款及细则"},
      li_66:{en:"Address: Minerva Learning Ltd., Hong Kong",zhTW:"從事欺詐活動",zhCN:"从事欺诈活动"},
