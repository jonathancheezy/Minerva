...
(function(){
  const T = {
    ...
    terms:{
      ...
      sec10:{en:"Minerva reserves the right to modify these Terms at any time. Continued use of the platform after changes constitutes acceptance of the modified Terms.",zhTW:"10. 修訂",zhCN:"10. 修订"},
      ...
      lessons_conducted:{en:"Lessons conducted",zhTW:"課堂可按以下方式進行",zhCN:"课堂可按以下方式进行"},
      ...
      sec11:{en:"Teacher Responsibilities",zhTW:"11. 導師責任",zhCN:"11. 导师责任"},
      sec12:{en:"Platform Fees & Commission",zhTW:"12. 平台費用及佣金",zhCN:"12. 平台费用及佣金"},
      sec13:{en:"Payment Terms",zhTW:"13. 付款條款",zhCN:"13. 付款条款"},
      sec14:{en:"Dispute Resolution",zhTW:"14. 爭議解決",zhCN:"14. 争议解决"},
      sec14_1:{en:"For Parents",zhTW:"14.1 給家長",zhCN:"14.1 给家长"},
      sec14_2:{en:"For Teachers",zhTW:"14.2 給導師",zhCN:"14.2 给导师"},
      sec14_3:{en:"Evidence",zhTW:"14.3 證據",zhCN:"14.3 证据"},
      sec14_4:{en:"Decision",zhTW:"14.4 解決時間表",zhCN:"14.4 解决时间表"},
      sec14_5:{en:"Appeal",zhTW:"14.5 退款流程",zhCN:"14.5 退款流程"},
      sec14_6:{en:"Escalation",zhTW:"14.6 香港小額錢債審裁處",zhCN:"14.6 香港小额钱债审裁处"},
      sec14_7:{en:"Excluded Disputes",zhTW:"14.7 資料轉讓",zhCN:"14.7 资料转让"},
      sec15:{en:"Indemnification",zhTW:"15. 知識產權",zhCN:"15. 知识产权"},
      sec16:{en:"Limitation of Liability",zhTW:"16. 私隱政策",zhCN:"16. 隐私政策"},
      sec17:{en:"Termination",zhTW:"17. 適用法律",zhCN:"17. 适用法律"},
      sec18:{en:"Governing Law",zhTW:"18. 終止",zhCN:"18. 终止"},
      sec19:{en:"Entire Agreement",zhTW:"19. 聯繫我們",zhCN:"19. 联系我们"},
      sec2:{en:"Eligibility",zhTW:"資格",zhCN:"資格"},
      sec20:{en:"Amendments",zhTW:"20. 修訂",zhCN:"20. 修订"},
      ...
      sec5_1:{en:"Scheduling",zhTW:"5.1 平台費用",zhCN:"5.1 平台费用"},
      sec5_2:{en:"Lesson Format",zhTW:"5.2 付款保護",zhCN:"5.2 付款保障"},
      sec5_3:{en:"Cancellations",zhTW:"5.3 退款",zhCN:"5.3 退款"},
      sec5_4:{en:"Refunds",zhTW:"5.4 付款釋出",zhCN:"5.4 付款释放"},
      sec6:{en:"Payments & Pricing",zhTW:"6. 導師驗證",zhCN:"6. 导师验证"},
      sec7:{en:"Minerva Verification",zhTW:"7. 課堂安排",zhCN:"7. 课堂安排"},
      sec7_1:{en:"For Teachers",zhTW:"7.1 預約",zhCN:"7.1 预约"},
      sec7_2:{en:"For Parents",zhTW:"7.2 地點",zhCN:"7.2 地点"},
      sec8:{en:"Data & Privacy",zhTW:"8. 資料及私隱",zhCN:"8. 资料及私隐"},
      sec9:{en:"Minerva Guarantee",zhTW:"9. Minerva保證",zhCN:"9. Minerva保证"},
      users_must_not:{en:"Users must not",zhTW:"用戶不得",zhCN:"用戶不得"},
      li_1:{en:"Escrow payment processing for lesson fees",zhTW:"身份驗證及背景核查服務",zhCN:"身份验证及背景核查服务"},
      li_2:{en:"Online scheduling and lesson management",zhTW:"課堂費用的託管付款處理",zhCN:"课堂费用的托管付款处理"},
      li_3:{en:"Learning progress tracking tools",zhTW:"網上預約及課堂管理",zhCN:"网上预约及课堂管理"},
      li_4:{en:"Dispute resolution assistance",zhTW:"學習進度追蹤工具",zhCN:"学习进度追踪工具"},
      li_5:{en:"4. User Accounts",zhTW:"爭議解決協助",zhCN:"争议解决协助"},
      li_6:{en:"Qualifications and teaching credentials",zhTW:"有效身份證明文件",zhCN:"有效身份证明文件"},
      li_7:{en:"Accurate subject and availability information",zhTW:"資歷及教學資格",zhCN:"资历及教学资格"},
      li_8:{en:"Teachers are solely responsible for maintaining the confidentiality of their account credentials and for all activities under their account.",zhTW:"準確的科目及可用時間資訊",zhCN:"准确的科目及可用时间信息"},
      li_9:{en:"Providing accurate student information",zhTW:"維護帳戶憑證的機密性",zhCN:"维护帐户凭证的机密性"},
      li_10:{en:"Reviewing teacher credentials independently",zhTW:"確保付款資訊為最新",zhCN:"确保付款信息为最新"},
      li_11:{en:"5. Payment Terms",zhTW:"提供準確的學生資訊",zhCN:"提供准确的学生信息"},
      li_12:{en:"Lessons cancelled within 24 hours: 50% refund",zhTW:"獨立核實導師資歷",zhCN:"独立核实导师资历"},
      li_13:{en:"No-show by teacher: Full refund to student",zhTW:"課堂前24小時以上取消：全額退款",zhCN:"课堂前24小时以上取消：全额退款"},
      li_14:{en:"No-show by student: No refund, payment to teacher",zhTW:"24小時內取消：50%退款",zhCN:"24小时内取消：50%退款"},
      li_15:{en:"5.3 Commission",zhTW:"導師無故缺席：全額退款给学生",zhCN:"导师无故缺席：全额退款给学生"},
      li_16:{en:"Qualification checks",zhTW:"學生無故缺席：恕不退還，款項支付予導師",zhCN:"学生无故缺席：恕不退还，款项支付予导师"},
      li_17:{en:"Reference verification",zhTW:"付款於課堂完成確認後3個工作日內釋出",zhCN:"付款于课堂完成确认后3个工作日内放出"},
      li_18:{en:"Interview assessment",zhTW:"高峰期最多5個工作日",zhCN:"高峰期最多5个工作日"},
      li_19:{en:"While we strive for thorough verification, Minerva does not guarantee the ongoing quality of teaching and shall not be held liable for any deficiency in teaching services. Users are encouraged to conduct their own due diligence.",zhTW:"身份驗證（香港身份證/護照）",zhCN:"身份验证（香港身份证/护照）"},
      li_20:{en:"Online via video conferencing",zhTW:"資歷核查",zhCN:"资历核查"},
      li_21:{en:"Hybrid arrangements as agreed between parties",zhTW:"推薦人核查",zhCN:"推荐人核查"},
      li_22:{en:"7.3 Cancellations",zhTW:"面試評估",zhCN:"面试评估"},
      li_23:{en:"Forfeit of escrow payment protection",zhTW:"按約定地點面授",zhCN:"按约定地点面授"},
      li_24:{en:"Legal action for breach of contract",zhTW:"透過視像會議網上授課",zhCN:"透过视像会议网上授课"},
      li_25:{en:"This policy protects both parties and ensures Minerva can provide dispute resolution and payment protection services.",zhTW:"由雙方協定的混合安排",zhCN:"由双方协定的混合安排"},
      li_26:{en:"Is defamatory, abusive, or discriminatory",zhTW:"即時帳戶暫停",zhCN:"即时帐户暂停"},
      li_27:{en:"Contains spam or promotional content",zhTW:"喪失託管付款保障",zhCN:"丧失托管付款保障"},
      li_28:{en:"Violates applicable laws",zhTW:"就違反合約採取法律行動",zhCN:"就违反合约采取法律行动"},
      li_29:{en:"Disputes regarding reviews should be reported to support@minerva.hk within 14 days of posting.",zhTW:"包含個人資訊（電話號碼、地址）",zhCN:"包含个人信息（电话号码、地址）"},
      li_30:{en:"Minerva shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from use of the platform.",zhTW:"具誹謗、虐待或歧視性質",zhCN:"具诽谤、虐待或歧视性质"},
      li_31:{en:"Minerva does not warrant the accuracy of teacher qualifications or student information beyond our verification process.",zhTW:"包含垃圾訊息或宣傳內容",zhCN:"包含垃圾讯息或宣传内容"},
      li_32:{en:"Users assume full responsibility for verifying teacher credentials and making informed decisions.",zhTW:"違反適用法律",zhCN:"违反适用法律"},
      li_33:{en:"Minerva shall not be liable for any loss of income, reputation, or business opportunities arising from platform use.",zhTW:"Minerva作為中間平台，對導師、學生或家長的行為不承擔責任",zhCN:"Minerva作为中间平台，对导师、学生或家长的行为不承担责任"},
      li_34:{en:"11. Force Majeure",zhTW:"Minerva不對任何間接、偶然、特殊、後果性或懲罰性損害賠償負責",zhCN:"Minerva不对任何间接、偶然、特殊、后果性或惩罚性损害赔偿负责"},
      li_35:{en:"Matching teachers with students",zhTW:"我們對任何索償的總責任不超過索償人所提出的索償金額",zhCN:"我们对任何索偿的总责任不超过索偿人提出的索偿金额"},
      li_36:{en:"Payment processing",zhTW:"Minerva不保證導師資歷的準確性",zhCN:"Minerva不保证导师资历的准确性"},
      li_37:{en:"Platform improvement and analytics",zhTW:"用戶承擔驗證導師資歷的全部責任",zhCN:"用户承担验证导师资历的全部责任"},
      li_38:{en:"Communication about services",zhTW:"Minerva不對任何收入損失、名譽損失或業務損失負責",zhCN:"Minerva不对任何收入损失、名誉损失或业务损失负责"},
      li_39:{en:"14.2 Data We Collect",zhTW:"帳戶註冊及驗證",zhCN:"帐户注册及验证"},
      li_40:{en:"HKID/Passport for verification",zhTW:"為導師及學生配對",zhCN:"为导师及学生配对"},
      li_41:{en:"Qualification documents",zhTW:"付款處理",zhCN:"付款处理"},
      li_42:{en:"Payment information",zhTW:"平台改進及分析",zhCN:"平台改进及分析"},
      li_43:{en:"Lesson history and progress data",zhTW:"關於服務的通訊",zhCN:"关于服务的通讯"},
      li_44:{en:"Communication records",zhTW:"姓名及聯繫方式",zhCN:"姓名及联系方式"},
      li_45:{en:"14.3 Use of Data",zhTW:"香港身份證/護照以作驗證",zhCN:"香港身份证/护照以作验证"},
      li_46:{en:"Processing payments via Stripe, Alipay, WeChat Pay",zhTW:"資格文件",zhCN:"资格文件"},
      li_47:{en:"Teacher verification through third-party services",zhTW:"付款資訊",zhCN:"付款信息"},
      li_48:{en:"Analytics to improve our platform",zhTW:"課堂歷史及進度數據",zhCN:"课堂历史及进度数据"},
      li_49:{en:"Legal compliance",zhTW:"通訊記錄",zhCN:"通讯记录"},
      li_50:{en:"14.4 Data Retention",zhTW:"提供及維護我們的服務",zhCN:"提供及维护我们的服务"},
      li_51:{en:"Request correction of inaccurate data",zhTW:"通過Stripe、Alipay、WeChat Pay處理付款",zhCN:"通过Stripe、Alipay、WeChat Pay处理付款"},
      li_52:{en:"Request deletion of your data (subject to legal retention requirements)",zhTW:"通過第三方服務進行導師驗證",zhCN:"通过第三方服务进行导师验证"},
      li_53:{en:"Withdraw consent for marketing communications",zhTW:"分析以改進我們的平台",zhCN:"分析以改进我们的平台"},
      li_54:{en:"To exercise these rights, contact us at privacy@minerva.hk",zhTW:"法律合規",zhCN:"法律合规"},
      li_55:{en:"Harass, abuse, or harm other users",zhTW:"要求查閱您的個人資料",zhCN:"要求查阅您的个人资料"},
      li_56:{en:"Attempt to circumvent our verification process",zhTW:"要求更正不正確的資料",zhCN:"要求更正不正确的资料"},
      li_57:{en:"Make off-platform payments to avoid commissions",zhTW:"要求刪除您的資料（須受法律保留要求約束）",zhCN:"要求删除您的资料（须受法律保留要求约束）"},
      li_58:{en:"Provide false information during registration",zhTW:"撤回對營銷通訊的同意",zhCN:"撤回对营销通讯的同意"},
      li_59:{en:"Use the platform to solicit other users for external services",zhTW:"將平台用於非法目的",zhCN:"将平台用于非法目的"},
      li_60:{en:"17. Dispute Resolution",zhTW:"騷擾、虐待或傷害其他用戶",zhCN:"骚扰、虐待或伤害其他用户"},
      li_61:{en:"Engage in fraudulent activity",zhTW:"嘗試規避我們的驗證流程",zhCN:"尝试规避我们的验证流程"},
      li_62:{en:"Repeatedly breach payment obligations",zhTW:"進行平台外付款以規避佣金",zhCN:"进行平台外付款以规避佣金"},
      li_63:{en:"Generate multiple justified complaints",zhTW:"在註冊時提供虛假資訊",zhCN:"在注册时提供虚假信息"},
      li_64:{en:"19. Amendments",zhTW:"使用平台招攬其他用戶使用外部服務",zhCN:"使用平台招揽其他用户使用外部服务"},
      li_65:{en:"Address: Minerva Learning Ltd., Hong Kong",zhTW:"違反這些條款及細則",zhCN:"违反这些条款及细则"},
      li_66:{en:"© 2026 Minerva Learning Ltd. All rights reserved. Registered in Hong Kong.",zhTW:"從事欺詐活動",zhCN:"从事欺诈活动"},
